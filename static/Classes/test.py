...
if __name__ == "__main__":
    ...
    print "  Passed test 1"
    assert DB.getCustomPath(250, 290, "JKB") == {'buildingInfo': {'phone_number': '801-422-3006', 'hours': '', 'in_DB': True, 'id': 'JKB', 'name': 'Jesse Knight Building'}, 'endCoord': {'latitude': '40.249608', 'in_DB': True, 'building_id': 'JKB', 'id': 32L, 'longitude': '-111.649815'}, 'floorPlans': ['/static/FloorPlans/JKB/jkb-1d.pdf', '/static/FloorPlans/JKB/jkb-2d.pdf', '/static/FloorPlans/JKB/jkb-3d.pdf', '/static/FloorPlans/JKB/jkb-4d.pdf'], 'startCoord': {'latitude': 250, 'in_DB': False, 'building_id': '', 'id': 0, 'longitude': 290}}
    print "  Passed test 2"
    ...
    assert DB.saveSchedule('test_user', 'test_schedule', courses)
    print "  Passed saving schedule"
    assert DB.loadSchedule('test_user', 'test_schedule')['in_DB'] == True
